...
def evaluation(sess, model):
    ...
    draw_prc(y, ano_scores, key='AnoGAN_'+method)
...
with tf.Session() as sess:
    ...
    # model.restore(sess, 'train_logs_0.8320_fm/talkingdata/fm/0.9/1/ckpt')
    model.restore(sess, 'train_logs_0.8130_ce/talkingdata/cross-e/0.9/1/ckpt')
